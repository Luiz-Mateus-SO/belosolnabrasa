...
function my_scripts() {
    ...
    wp_register_script('menu-functions', get_template_directory_uri() . '/js/copy-section.js', [], false, true);
    wp_enqueue_script('copy-section'); // Enqueue o script menu-functions.js
}
